...
cbindgen --lang c ../../rust -o ZKGroup/libzkgroup/zkgroup.h
# Simulator:
...
cargo +nightly build --manifest-path=../../rust/Cargo.toml -Z build-std --target x86_64-apple-ios-macabi --release > /dev/null 2>&1
...
# iOS
#lipo -create -output out/libzkgroup_ios.a target/{aarch64-apple-ios,x86_64-apple-ios}/release/libzkgroup.a
#echo "Wrote out/libzkgroup_ios.a"
